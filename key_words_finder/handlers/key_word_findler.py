...
documents1 = [
    ...
    {"id": 4,
        ...
        "image_irl": [  
            r'D:\Downloads\Screenshot_3.jpg',
            r'D:\Downloads\Screenshot_4.jpg'
        ]},
    {"id": 5,
...
async def process_message(message: types.Message, state: FSMContext):
    ...
    if results:
        ...
        image_path = next((doc['image_irl'] for doc in all_documents if doc['id'] == document_id), None)   # Получаем путь к изображению
